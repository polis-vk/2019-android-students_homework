...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentCreator.setAddListener(student->{studentList.add(student);studentAdapter.notifyDataSetChanged();});
        studentCreator.setDeleteListener(student -> {studentList.remove(student);studentAdapter.notifyDataSetChanged();});
        studentCreator.setSaveListener((student)->{studentAdapter.notifyDataSetChanged();});
    }
